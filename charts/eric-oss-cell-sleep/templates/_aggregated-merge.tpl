...
*/ -}}
{{- define "eric-oss-cell-sleep.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-cell-sleep.mergeAnnotations" -}}
  {{- include "eric-oss-cell-sleep.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-cell-sleep.mergeLabels" -}}
  {{- include "eric-oss-cell-sleep.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
