...
CMD ["/bin/sh", "-c", "java ${JAVA_OPTS} -Dcom.sun.management.jmxremote=true \
    ...
    -jar eric-oss-cell-sleep-app.jar"]
...
LABEL \
    org.opencontainers.image.title=eric-oss-cell-sleep-jsb \
